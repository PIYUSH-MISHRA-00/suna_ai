import 'package:suna_ai/model/radio.dart';
import 'package:suna_ai/utils/ai_util.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "10a5f18831a760e6f16c6a8eb84796442e956eca572e1d8b807a3e2338fdd0dc/stage",
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          [
            AppBar(
              title: "suna_ai".text.xl4.bold.white.make().shimmer(
